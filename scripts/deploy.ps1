...
# ═══════════════════════════════════════════════════════════════════════
# Step 5: Apply production manifests
# ═══════════════════════════════════════════════════════════════════════
...
Write-Host ""
Write-Host "TIP: To authenticate Docker to GHCR first, run:" -ForegroundColor Yellow
Write-Host "  echo `$env:GHCR_PAT | docker login ghcr.io -u <username> --password-stdin" -ForegroundColor Yellow

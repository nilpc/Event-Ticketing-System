...
async def test_full_booking_flow(client: AsyncClient) -> None:
    ...
    r = await client.post('/v1/admin/showtimes', json={'event_id': event_id, 'venue_id': venue_id, 'base_price': 75.0, 'start_time': start, 'end_time': end, 'auto_seats': True}, headers=admin_h)

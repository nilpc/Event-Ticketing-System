...
from services.booking.schemas.catalog import EventResponse, SeatMapResponse, ShowtimeResponse, VenueResponse
...
async def get_seat_map(show_id: UUID, svc: CatalogService=Depends(_get_catalog_service)) -> SeatMapResponse:

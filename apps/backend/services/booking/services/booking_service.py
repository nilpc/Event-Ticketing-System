...
class BookingService:
    ...
    async def initialize_checkout(
        ...
        return BookResponse(
            booking_id=booking_id, status=BookingStatus.PENDING.value, expires_at=expires_at
        )
    ...
    async def mock_confirm_booking(self, booking_id: uuid.UUID) -> MockConfirmResponse:
        ...
        return MockConfirmResponse(
            booking_id=booking_id, status=BookingStatus.CONFIRMED.value, seat_ids=seat_ids
        )

...
class TestCatalogCacheAside:
    ...
    async def test_list_showtimes_uses_cache(self, catalog_service: CatalogService, mock_cache_repo: AsyncMock) -> None:
        show_id = uuid4()
        mock_cache_repo.get.return_value = json.dumps([{'show_id': str(show_id), 'event_id': f'STE{uuid4().hex[:6].upper()}', 'venue_id': str(uuid4()), 'base_price': '25.00', 'start_time': '2026-08-01T18:00:00Z', 'end_time': '2026-08-01T21:00:00Z'}])

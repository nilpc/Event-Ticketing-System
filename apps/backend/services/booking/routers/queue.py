...
async def join_queue(
    payload: QueueJoinRequest, request: Request, svc: QueueService = Depends(_get_queue_service)
) -> QueueJoinResponse:
...
async def queue_status(
    show_id: str, request: Request, svc: QueueService = Depends(_get_queue_service)
) -> QueueStatusResponse:
    from uuid import UUID

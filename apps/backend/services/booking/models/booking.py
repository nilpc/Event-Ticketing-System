...
class Booking(Base):
    ...
    __table_args__ = (ForeignKeyConstraint(['show_id', 'seat_id'], ['booking.seats.show_id', 'booking.seats.seat_id'], ondelete='CASCADE'), {'schema': 'booking'})
    ...
    status: Mapped[BookingStatus] = mapped_column(Enum(BookingStatus, name='booking_status', create_type=False), nullable=False, default=BookingStatus.PENDING)

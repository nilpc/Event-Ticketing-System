"""Decouple cross-schema FK from booking.bookings to identity.users and add outbox NOTIFY trigger.
...
def upgrade() -> None:
    ...
    # 2. Add PostgreSQL LISTEN/NOTIFY trigger on booking.outbox_events
    op.execute(
        """

...
async def list_events(_merchant: User=Depends(_require_merchant), svc: AdminService=Depends(_get_admin_service)) -> list[AdminEventResponse]:
...
async def list_venues(_merchant: User=Depends(_require_merchant), svc: AdminService=Depends(_get_admin_service)) -> list[AdminVenueResponse]:
...
async def list_showtimes(_merchant: User=Depends(_require_merchant), svc: AdminService=Depends(_get_admin_service)) -> list[ShowtimeResponse]:

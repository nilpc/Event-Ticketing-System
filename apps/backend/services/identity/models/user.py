...
class User(Base):
    ...
    is_master_admin: Mapped[bool] = mapped_column(Boolean, default=False)
...
class RefreshToken(Base):
    ...
    user_id: Mapped[uuid.UUID] = mapped_column(UUID(as_uuid=True), ForeignKey('identity.users.user_id', ondelete='CASCADE'), nullable=False)

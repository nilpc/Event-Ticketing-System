...
@router.post('/lock', response_model=SeatLockResponse, responses={409: {'model': dict}})
async def lock_seats(payload: SeatLockRequest, request: Request, svc: SeatLockService=Depends(_get_seat_lock_service)) -> SeatLockResponse:

...
class ShowtimeCreate(BaseModel):
    event_id: str
    venue_id: str
    front_price: Decimal = Field(decimal_places=2, ge=0)
    middle_price: Decimal = Field(decimal_places=2, ge=0)
    back_price: Decimal = Field(decimal_places=2, ge=0)
    start_time: datetime
    end_time: datetime
...
class ShowtimeUpdate(BaseModel):
    front_price: Decimal | None = Field(default=None, decimal_places=2, ge=0)
    middle_price: Decimal | None = Field(default=None, decimal_places=2, ge=0)
    back_price: Decimal | None = Field(default=None, decimal_places=2, ge=0)

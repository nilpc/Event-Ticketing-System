...
def init_sentry(dsn: str, environment: str='development') -> None:
    ...
    def _scrub_request(event: dict[str, object], _hint: dict[str, object]) -> dict[str, object] | None:
        ...
        return event
    sentry_sdk.init(dsn=dsn, environment=environment, traces_sample_rate=0.1, profiles_sample_rate=0.1, integrations=[FastApiIntegration(failed_request_status_codes={500, 501, 502, 503, 504}), SqlalchemyIntegration()], before_send=_scrub_request, send_default_pii=False)
